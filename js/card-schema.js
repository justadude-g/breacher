...
const TEMPLATES = {
  ...
  opfor: {
    ...
    fields: [
      ...
      { group:'FOP Calculator' },
      { key:'_fop', type:'fop-calc', label:'FOP Calculator',
        hint:'Select a unit type to auto-fill stats and calculate FOP. Adjust models and upgrades as needed.' },
      { group:'Stats' },
